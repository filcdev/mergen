...
import hu.petrik.filcapp.api.infrastructure.ApiClient
 ...
 */
object AuthConfig {
    /** Must equal `CHRONOS_ENTRA_CLIENT_ID`. */
    const val ENTRA_CLIENT_ID = ""

    /** Must equal `CHRONOS_ENTRA_TENANT_ID` (tenant GUID or verified domain). */
    const val ENTRA_TENANT_ID = ""
    ...
    /** Chronos API root, shared with the generated client. */
    const val API_BASE_URL = ApiClient.BASE_URL
     ...
     */
    const val TRUSTED_ORIGIN = "https://filc.space"
